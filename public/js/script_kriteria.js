...
function handleGetDataKriteriaById(id) {
  $.ajax({
    url: "http://localhost/takampus/public/data_kriteria/getDataKriteriaId",
    method: "POST",
    data: { id },
    dataType: "json",
...
function handleFormEditKriteria(id) {
  $("#form-kriteria").attr(
    "action",
    `http://localhost/takampus/public/Data_Kriteria/editKriteriaById/${id}`
  );
  handleGetDataKriteriaById(id);
}
function handleFormDeleteKriteria(id) {
  $("#form-delete-kriteria").attr(
    "action",
    `http://localhost/takampus/public/Data_Kriteria/deleteKriteriaById/${id}`
  );
}

// Subkriteria
function handleFormTambahSubKriteria() {
  $("#form-kriteria").attr(
    "action",
    "http://localhost/takampus/public/Data_Kriteria/tambahSubKriteria"
  );
}
