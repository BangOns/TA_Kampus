<header class="w-full flex justify-between items-center  ">
    ...
    <section class="basis-1/2 w-full hidden md:flex justify-end">
        <figure class="w-fit pl-4 pr-6 p-2 items-center  flex gap-2 rounded-full bg-slate-50 shadow-lg ">
            <img src="<?= BASEURL  ?>/img/image-profile.png" alt="profile" width="40" height="40"
                class="object-cover size-7 lg:size-10">
            <figcaption class="font-poppins ">
                <h2 class="text-sm sm:text-xs lg:text-sm">Syahroni </h2>
