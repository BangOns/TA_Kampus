<section class="w-full  mt-4 px-4 space-y-3">
    <section class="w-full  space-y-2">
        ...
        <input type="text" placeholder="Nama Santri..." name="nama_santri"
