...
function renderPelanggarSection($dataPelanggar, $menu)
{
    ...
    foreach ($dataPelanggar as $index => $pelanggar) {
        ...
        include dirname(__DIR__, 4) . '/public/icons/icons-dropdown.svg';
        echo '</div>';
        echo '</button>';
        ...
        foreach ($menu as $mn) {
            ...
            echo  "<a href='{$mn['href']}' class='{$mn['class']} justify-center'>";
